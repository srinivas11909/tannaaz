...
<html lang="en">
    <head>
        ...
        <title>Admin Panel | Taannaz</title>
        <!-- Bootstrap -->
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Taannaz Admin</span></a>
                        </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <h3>New/Edit Listing</h3>
                                <ul class="nav side-menu">
                                    <li class="active">
                                        <a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: block;">
                                            <li><a href="/cmsPosting/postListing">New Listing</a></li>
                                            <li><a href="/cmsPosting/viewListings">View Listings</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
